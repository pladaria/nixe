...
impl Translator<'_> {
    pub(crate) fn system_value(&self, guest: GuestValue) -> Result<ir::Value, Error> {
        self.values.get(guest)
    }
        ...
        match instruction {
            ...
            Instruction::WriteRegister(_) => {
                ...
                match f.system_key {
                    ...
                    0xd51b_d040 => {
                        self.values.system[system_index(GuestValue::TpidrEl0)] = Some(value);
