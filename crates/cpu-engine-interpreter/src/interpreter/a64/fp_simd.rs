...
fn duplicate_general(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
...
fn modified_immediate(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
    let immediate =
...
fn insert_element(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
...
fn insert_general(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
    let (lane_bits, destination_lane) = insert_lane_shape(fields.immediate_5);
...
fn scalar_float_immediate(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
...
fn integer_add_sub(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
    let vector_bits = if fields.vector_128 { 128 } else { 64 };
...
fn extract_vector(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
...
fn shift_right_narrow(state: &mut A64State, fields: nixe_cpu::decode::a64::fp_simd::Operands) {
